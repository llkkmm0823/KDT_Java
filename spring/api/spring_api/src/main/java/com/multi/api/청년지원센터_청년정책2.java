...
public class 청년지원센터_청년정책2 {
	...
	public YoungVO parse() {	//url + parameter
		...
		vo.setBizId(arr.getJSONObject(0).getString("bizId"));
		vo.setCnsgNmor(arr.getJSONObject(0).getString("cnsgNmor"));
		vo.setPlcyTpNm(arr.getJSONObject(0).getString("plcyTpNm"));
		vo.setPolyBizSjnm(arr.getJSONObject(0).getString("polyBizSjnm"));
		vo.setRqutProcCn(arr.getJSONObject(0).getString("rqutProcCn"));
